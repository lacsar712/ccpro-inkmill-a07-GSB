...
class EnergyDaily(Base):
    ...
    __table_args__ = (
        UniqueConstraint("workshop_id", "work_date", name="uq_energy_daily_workshop_date"),
    )
    ...
    kwh: Mapped[Decimal] = mapped_column(Numeric(12, 2), nullable=False, default=0)
    peak_kw: Mapped[Decimal | None] = mapped_column(Numeric(10, 2), nullable=True)
